    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/profile" element={<ProtectedRoute><Profile /></ProtectedRoute>}>
          ...
          <Route path="modifier-password" element={<PasswordForm />} />
        </Route>
        ...
        <Route path="/signin" element={<ProtectedRoutAuth><Login /></ProtectedRoutAuth>} />
        <Route path="/signup" element={<ProtectedRoutAuth><Register /></ProtectedRoutAuth>} />
        <Route path="/verfei" element={<ProtectedRoutAuth><VerfieOtp /></ProtectedRoutAuth>} />
        <Route path="/forget-password" element={<ProtectedRoutAuth><ForgetPassword /></ProtectedRoutAuth>} />
        <Route path="/update-password" element={<ProtectedRoutAuth><UpdatPassword /></ProtectedRoutAuth>} />
      </Routes>
    </>
  );
}
